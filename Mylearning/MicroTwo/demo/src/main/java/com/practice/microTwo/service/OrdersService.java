...
public class OrdersService {
	...
	public List<OrdersDto> getOrdersByCustId(Long id) {
		List<OrdersEntity> entityList=repo.findOrdersBycustomerId(id);
		List<OrdersDto> dtoList=new ArrayList<>();
		for(OrdersEntity entity:entityList)
		{
			OrdersDto ordersDto=new OrdersDto();
	...
	public List<OrdersDto> getOrdersGreater(long id)
	{
		List<OrdersEntity> entityList=repo.getQuantitygreater(id);
